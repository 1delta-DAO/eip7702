export const nexusAccountAbi = [
  ...
  { inputs: [], name: "AccountAlreadyInitialized", type: "error" },
  ...
  { inputs: [], name: "ERC7702AccountCannotBeUpgradedThisWay", type: "error" },
  { inputs: [], name: "EmergencyTimeLockNotExpired", type: "error" },
  ...
  { inputs: [], name: "ImplementationIsNotAContract", type: "error" },
  { inputs: [], name: "InnerCallFailed", type: "error" },
  { inputs: [], name: "InvalidConstraintType", type: "error" },
  { inputs: [], name: "InvalidImplementationAddress", type: "error" },
  { inputs: [], name: "InvalidInitData", type: "error" },
  ...
  { inputs: [], name: "InvalidPREP", type: "error" },
  ...
  { inputs: [], name: "NexusInitializationFailed", type: "error" },
  ...
  {
    inputs: [{ internalType: "ExecutionMode", name: "mode", type: "bytes32" }],
