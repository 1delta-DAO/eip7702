export const bootstrapAbi = [
  ...
  { inputs: [], name: "DefaultValidatorAlreadyInstalled", type: "error" },
  { inputs: [], name: "EmergencyUninstallSigError", type: "error" },
  { inputs: [], name: "EnableModeSigError", type: "error" },
  {
    inputs: [{ internalType: "bytes4", name: "selector", type: "bytes4" }],
    name: "FallbackAlreadyInstalledForSelector",
    type: "error",
  },
  { inputs: [], name: "FallbackCallTypeInvalid", type: "error" },
  { inputs: [], name: "FallbackHandlerUninstallFailed", type: "error" },
  {
    inputs: [{ internalType: "bytes4", name: "selector", type: "bytes4" }],
    name: "FallbackNotInstalledForSelector",
    type: "error",
  },
  { inputs: [], name: "FallbackSelectorForbidden", type: "error" },
  {
  ...
  { inputs: [], name: "MismatchModuleTypeId", type: "error" },
  {
    inputs: [{ internalType: "bytes4", name: "selector", type: "bytes4" }],
    name: "MissingFallbackHandler",
    type: "error",
  },
  { inputs: [], name: "ModuleAddressCanNotBeZero", type: "error" },
  {
    inputs: [
      { internalType: "uint256", name: "moduleTypeId", type: "uint256" },
  ...
  { inputs: [], name: "NoValidatorInstalled", type: "error" },
  {
    inputs: [
      {
  ...
  },
  {
    ...
    outputs: [{ internalType: "bool", name: "installed", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  {
